...
2.  **Aba Simuladores:**
    *   *Simulador Mercado Pago:* Permite escolher um pedido pendente e liquidá-lo de forma mockada, forçando a alteração de status e disparando o webhook.
    *   *Simulador Melhor Envio:* Campo para testar cotações de CEPs mockados com retorno formatado.
