...
- **Paletas Sazonais por Sazonalidade:** Temos dois grupos curados prontos para aplicação instantânea com um clique:
  - **🎉 Datas Especiais & Festas:** _Dia das Mães 🌸_ (rosa antigo e creme), _Natal Mágico 🎄_ (vermelho cereja e verde pinheiro) e _Ano Novo Real 🌟_ (champanhe e seda off-white).
  - **🍂 Estações do Ano:** _Primavera/Verão ☀️_ (amarelo sol e areia) e _Outono/Inverno 🍂_ (terracota e cacau profundo).
