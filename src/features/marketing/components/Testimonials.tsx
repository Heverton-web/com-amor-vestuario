          ...
          <div className="overflow-hidden">
            ...
            >
              {items.map((t, i) => (
                ...
                >
                  <figure
                    className="rounded-3xl border border-primary-foreground/15 bg-primary-foreground/5 p-7 backdrop-blur min-h-[220px] flex flex-col justify-between"
                  >
                    <div>
              ...
              {Array.from({ length: maxIndex + 1 }).map((_, idx) => (
                <button
                  ...
                  className={`h-1.5 rounded-full transition-all duration-500 ${
                    currentIndex === idx ? "w-5 bg-primary-foreground" : "w-1.5 bg-primary-foreground/30 hover:bg-primary-foreground/55"
                  }`}
