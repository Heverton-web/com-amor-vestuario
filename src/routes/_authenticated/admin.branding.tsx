...
const tabSections = {
  identidade: {
    ...
    description:
      "Defina o nome da sua marca, slogan, logotipos transparentes específicos para cada ambiente e personalize sua paleta de cores.",
    groups: [
      {
        title: "Marca & Slogan",
        fields: [
        ...
        fields: [
          {
            ...
            type: "image",
            hint: "Usado quando nenhum outro for definido",
          },
          {
            key: "logo_landing_url",
            label: "Logo da Landing Page",
            type: "image",
            hint: "Aparece na página institucional de entrada",
          },
          {
            key: "logo_loja_url",
            label: "Logo da Loja Virtual",
            type: "image",
            hint: "Aparece no e-commerce e catálogo",
          },
          {
            key: "logo_recompensas_url",
            label: "Logo do Clube de Recompensas",
            type: "image",
            hint: "Aparece na central de pontos e fidelidade",
          },
          {
            key: "logo_recibos_url",
            label: "Logo de Recibos & Faturamento",
            type: "image",
            hint: "Aparece no topo de faturas e PDFs",
          },
        ] as Field[],
      },
      {
  ...
  landing: {
    ...
    description:
      "Personalize os banners de impacto, textos editoriais do Atelier e configure as principais chamadas para ação (CTAs).",
    groups: [
      {
  ...
  contatos: {
    ...
    description:
      "Mantenha atualizados os dados de contato do suporte, links de mídias sociais e a agenda semanal de funcionamento físico.",
    groups: [
      {
  ...
  recibos: {
    ...
    description:
      "Informe os dados fiscais e de chancela digital que serão aplicados nas faturas e nos recibos gerados para os clientes.",
    groups: [
      {
      ...
      },
      {
        ...
        fields: [
          {
            key: "signature_url",
            label: "Assinatura digitalizada (PNG transparente)",
            type: "image",
          },
        ] as Field[],
      },
...
function BrandingPage() {
  ...
  const applyPalette = (p: {
    ...
    toast.success(
      `Paleta "${p.name}" selecionada! Clique em "Salvar tudo" para aplicar definitivamente.`,
    );
  };
  ...
  const saveCustomPalette = () => {
    ...
    toast.success(
      `Sua paleta "${newPalette.name}" foi adicionada! Lembre-se de "Salvar Tudo" para persistir no banco.`,
    );
  };
          ...
          <div className="space-y-6 lg:col-span-7">
              ...
              <div className="flex items-center justify-between gap-3 mb-3">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Preencha os dados essenciais para obter um visual completo de alta fidelidade.
                  </p>
                </div>
            ...
            {activeTab === "identidade" && (
              <div className="space-y-6">
                ...
                <div className="rounded-2xl border border-border bg-card p-6 shadow-sm space-y-5">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-display text-lg font-medium">
                      Paletas Temáticas e Sazonais
                    </h3>
                  </div>
                  <p className="text-xs text-muted-foreground">
                    Escolha estéticas prontas de alta costura inspiradas em estações e comemorações
                    importantes para renovar sua loja instantaneamente.
                  </p>

                  {/* Categoria Festividades */}
                  <div className="space-y-3">
                    <h4 className="text-[10px] font-semibold tracking-wider text-muted-foreground uppercase">
                      🎉 Datas Especiais & Festas
                    </h4>
                      ...
                      {seasonalPalettes.festividades.map((p) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <p className="text-[9px] text-muted-foreground leading-normal mb-3 flex-1">
                              {p.description}
                            </p>
                            <div className="flex items-center gap-1 mt-auto">
                              <span
                                className="h-4.5 w-4.5 rounded border border-foreground/5"
                ...
                <div className="rounded-2xl border border-border bg-card p-6 shadow-sm space-y-4">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Personalize as cores nos inputs abaixo, escolha um nome exclusivo e salve a sua
                    própria identidade de coleção.
                  </p>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 p-3 rounded-xl border border-dashed border-border bg-background/40 items-center justify-between">
                    <div className="flex items-center gap-3 w-full sm:w-auto">
                      ...
                      <div className="flex -space-x-1 shrink-0">
                        <span
                          className="h-6 w-6 rounded-full border border-background shadow"
                        ...
                        <span
                          className="h-6 w-6 rounded-full border border-background shadow"
                          style={{ background: draft?.foreground_color }}
                        />
                      </div>
                      <input
                        type="text"
                  ...
                  {draft?.custom_palettes && draft.custom_palettes.length > 0 ? (
                      ...
                      {draft.custom_palettes.map((p) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span className="text-[10px] font-bold pr-5 truncate block mb-2">
                              {p.name}
                            </span>
                            <div className="flex items-center gap-1 mt-auto">
                              <span
                                className="h-4 w-4 rounded-full border border-foreground/5"
                                style={{ background: p.primary }}
                              />
                              <span
                                className="h-4 w-4 rounded-full border border-foreground/5"
                    ...
                    <p className="text-[10px] text-muted-foreground italic text-center py-2">
                      Você ainda não criou nenhuma paleta própria.
                    </p>
                  )}
                </div>
              </div>
            ...
            <div className="space-y-6">
              {activeTabContent.groups.map((group) => (
                ...
                >
                  <h3 className="mb-4 text-xs font-semibold tracking-wider text-muted-foreground uppercase tracking-widest">
                    {group.title}
                  </h3>
                  ...
                  <div className="rounded-2xl border border-border bg-card p-6 shadow-sm space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <h3 className="font-display text-lg font-medium">
                          Galeria de Imagens (Landing Page)
                        </h3>
                      </div>
                      <button
                        type="button"
                    ...
                    <p className="text-xs text-muted-foreground">
                      As imagens da sua galeria aparecem na seção "Quem veste a gente". Você pode
                      fazer upload de fotos dos seus clientes reais, definir legendas e escolher se
                      a foto ocupa 1 espaço simples ou 2 espaços verticais (Grande).
                    </p>
                    ...
                    {draft.gallery_items && draft.gallery_items.length > 0 ? (
                      ...
                      <p className="text-xs text-muted-foreground italic text-center py-4">
                        Nenhuma imagem na galeria. Clique em "Adicionar Imagem" para começar.
                      </p>
                    )}
                  </div>
                  ...
                  <div className="rounded-2xl border border-border bg-card p-6 shadow-sm space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <Heart className="h-5 w-5 text-primary" />
                        <h3 className="font-display text-lg font-medium">
                          Depoimentos dos Clientes (Landing Page)
                        </h3>
                      </div>
                      <button
                        type="button"
                    ...
                    <p className="text-xs text-muted-foreground">
                      Configure depoimentos reais que mostram o carinho e cuidado da sua marca com
                      seus clientes. Eles aparecem no rodapé dinâmico da página inicial.
                    </p>
                    ...
                    {draft.testimonials && draft.testimonials.length > 0 ? (
                      ...
                      <p className="text-xs text-muted-foreground italic text-center py-4">
                        Nenhum depoimento configurado. Clique em "Adicionar Depoimento" para
                        começar.
                      </p>
                    )}
                  </div>
              ...
              <div className="flex items-center justify-center bg-secondary/30 rounded-2xl p-4 overflow-hidden border border-border/60">
                {previewMode === "mobile" ? (
                  ...
                  <div className="w-[280px] h-[500px] rounded-[36px] border-[6px] border-foreground/15 shadow-2xl bg-black overflow-hidden flex flex-col relative">
                    ...
                    {/* Tela Interna */}
                    <div
                      className="flex-1 flex flex-col overflow-y-auto scrollbar-none text-[10px] select-none pt-4 bg-background"
                      style={{
                        background: draft?.background_color,
                        color: draft?.foreground_color,
                      }}
                    >
                  ...
                  <div className="w-full h-[500px] rounded-xl border border-border shadow-2xl bg-black overflow-hidden flex flex-col">
                    ...
                    <div className="bg-[#1a1a1a] px-4 py-2 border-b border-zinc-800 flex items-center gap-1.5 z-10 shrink-0">
                      ...
                      <div className="mx-auto w-3/5 rounded bg-zinc-800 py-0.5 px-3 text-center text-[8px] text-zinc-500 truncate">
                        ...
                        {previewPage === "landing" ? "" : previewPage}
                      </div>
                    </div>

                    {/* Tela Interna */}
                    <div
                      className="flex-1 flex flex-col overflow-y-auto text-xs select-none bg-background animate-fade-in"
                      style={{
                        background: draft?.background_color,
                        color: draft?.foreground_color,
                      }}
...
function LivePreviewContent({
  ...
  const activeLogo = useMemo(() => {
    ...
    page,
    draft?.logo_url,
    draft?.logo_landing_url,
    draft?.logo_loja_url,
    draft?.logo_recompensas_url,
  ]);
    ...
    <div className="w-full flex flex-col flex-1">
      ...
      <header className="px-4 py-3 flex items-center justify-between border-b border-foreground/5 sticky top-0 bg-inherit backdrop-blur-sm z-10 transition-colors">
        {activeLogo ? (
          <img
            src={activeLogo}
            alt=""
            className="h-5 w-auto object-contain max-w-[85px] animate-fade-in"
          />
        ) : (
          <div className="flex items-baseline gap-1 text-xs">
            <Heart
              className="h-3 w-3 fill-primary stroke-primary text-primary"
              style={{ fill: draft?.primary_color, stroke: draft?.primary_color }}
            />
        ...
        <div className="flex gap-2.5 opacity-80 text-[8px] font-medium">
          <span
            className={page === "landing" ? "text-primary border-b border-primary" : ""}
            style={
              page === "landing"
                ? { color: draft?.primary_color, borderColor: draft?.primary_color }
                : {}
            }
          >
            Início
          ...
          <span
            className={page === "loja" ? "text-primary border-b border-primary" : ""}
            style={
              page === "loja"
                ? { color: draft?.primary_color, borderColor: draft?.primary_color }
                : {}
          ...
          <span
            className={page === "recompensas" ? "text-primary border-b border-primary" : ""}
            style={
              page === "recompensas"
                ? { color: draft?.primary_color, borderColor: draft?.primary_color }
                : {}
      ...
      {page === "landing" && (
        ...
        <div className="flex-1 flex flex-col">
          ...
          <section className="px-4 py-8 flex flex-col gap-4 relative overflow-hidden border-b border-foreground/5 bg-background min-h-[220px]">
            {/* Imagem do lado direito (w-2/5 no simulador) */}
            {draft?.hero_image_url && (
              <div className="absolute right-0 top-0 bottom-0 w-2/5 z-0">
                ...
                />
                {/* Degradê horizontal sutil restrito à borda esquerda da imagem no simulador */}
                <div className="absolute inset-y-0 left-0 w-12 bg-gradient-to-r from-background to-transparent z-10" />
              </div>
            )}

            {/* Conteúdo do Texto no Simulador */}
            <div className="relative z-10 space-y-2.5 max-w-[60%] flex flex-col justify-center h-full">
              <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full border border-border bg-card text-[5px] uppercase tracking-widest text-muted-foreground shadow-sm w-fit">
                <Heart
                  className="h-1.5 w-1.5 fill-primary stroke-primary text-primary"
                  style={{ fill: draft?.primary_color, stroke: draft?.primary_color }}
                />
                {draft?.tagline || "Modelagem exclusiva"}
              </span>
              <h1 className="font-serif text-[10px] font-semibold leading-tight text-foreground whitespace-pre-wrap">
                {draft?.hero_title || "Peças atemporais criadas com afeto."}
              </h1>
              <p className="text-[6px] text-muted-foreground leading-normal line-clamp-2">
                {draft?.hero_subtitle ||
                  "Moda lenta inspirada na delicadeza e na alfaiataria fina."}
              </p>
              <div className="flex gap-2 pt-0.5">
                <button
                  type="button"
                  className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[5px] font-bold shadow-sm transition-all whitespace-nowrap text-white"
                  style={{ backgroundColor: draft?.primary_color }}
                >
                  {draft?.cta_shop_label || "Ver Coleção"} <ArrowRight className="h-1 w-1" />
                </button>
              </div>
            </div>
          </section>
          ...
          <section className="px-4 py-6 border-b border-foreground/5 bg-background space-y-4">
            <div className="relative">
              ...
              <div
                className="absolute -inset-1.5 rounded-2xl border border-dashed opacity-45 -z-10 scale-95"
                style={{ borderColor: draft?.primary_color }}
              />
              ...
              {/* Selo do simulador */}
              <div
                className="absolute -right-1 -top-1 rounded-lg px-2 py-0.5 text-[5px] font-semibold text-white shadow-md"
                style={{ backgroundColor: draft?.primary_color }}
              >
                desde 2017
              </div>
            ...
            <div className="space-y-2">
              <span
                className="text-[5px] uppercase tracking-[0.25em] block"
              ...
              <p className="text-[7px] leading-relaxed text-muted-foreground line-clamp-4">
                {draft?.about_text ||
                  "Cada peça da nossa coleção passa por um processo de modelagem exclusivo. Valorizamos a produção justa e o acabamento meticuloso."}
              </p>

              {/* Manifesto no simulador */}
              <p
                className="border-l pl-2 text-[6px] italic text-muted-foreground font-serif"
                style={{ borderLeftColor: draft?.primary_color }}
              >
          ...
          <section
            className="px-4 py-6 border-b border-foreground/5 text-white space-y-3"
            style={{ backgroundColor: draft?.primary_color || "#3d3028" }}
          >
            <h2 className="font-serif font-medium text-xs text-center">
              A gente costura. Elas contam.
            </h2>
            <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-thin">
              {(draft?.testimonials?.length
                ...
                <div
                  key={idx}
                  className="w-[150px] shrink-0 bg-white/10 rounded-2xl p-3 border border-white/10 flex flex-col justify-between min-h-[90px]"
                >
        ...
        <div className="flex-1 flex flex-col p-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div
                key={idx}
                className="group rounded-xl border border-foreground/5 bg-foreground/[0.01] overflow-hidden flex flex-col"
              >
        ...
        <div className="flex-1 flex flex-col p-4 space-y-4">
          ...
          <div className="space-y-2">
            {[
              ...
              <div
                key={i}
                className="flex justify-between items-center p-3 rounded-xl border border-foreground/5 bg-foreground/[0.01]"
              >
                <div className="flex items-center gap-2">
                  <Gift
      ...
      <footer className="mt-auto px-4 py-6 border-t border-foreground/5 bg-foreground/[0.03] space-y-4">
        <div className="flex flex-col items-center text-center space-y-2">
          <div className="flex items-center gap-1 text-[9px] font-semibold">
            <Heart
              className="h-2.5 w-2.5 fill-primary stroke-primary text-primary"
              style={{ fill: draft?.primary_color, stroke: draft?.primary_color }}
            />
            <span>{brandTitle}</span>
          </div>
          <span className="text-[7px] opacity-60 leading-normal">
            {draft?.tagline || "Alfaiataria consciente e atemporal"}
          </span>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3 p-3 rounded-xl border border-border bg-background/50 shadow-inner">
          ...
          <div className="flex flex-col gap-1 flex-1">
            ...
            <span className="text-[9px] text-muted-foreground leading-normal">
              {field.hint || "PNG ou SVG com fundo transparente recomendado."}
            </span>
          </div>
          <input
            ref={fileRef}
